;; Site provided http://jasonm23.github.com/emacs-theme-editor/

(defun color-theme-customized ()
  (interactive)
  (color-theme-install
   '(color-theme-customized
     ...
     (font-lock-comment-face ((t (:foreground "#008b8b"))))
...
(provide 'color-theme-customized)
